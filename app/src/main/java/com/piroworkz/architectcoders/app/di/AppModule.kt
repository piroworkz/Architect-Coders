...
object AppModule {
    ...
    @Provides
    @DatabaseName
    fun provideDatabaseName(application: Application): String =
    ...
    fun provideBaseUrl(application: Application): String =
        application.getString(R.string.geo_base_url)
    ...
    @Singleton
    @Provides
    fun provideAppDatabase(application: Application, @DatabaseName name: String): AppDatabase =
